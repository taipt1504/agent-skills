---
name: verification
description: Comprehensive verification pipeline — compile, test, coverage, security, static analysis, and diff review for Java Spring projects
---
...
```bash
# Blocking call detection (WebFlux projects)
...
# SELECT * and exposed entities
grep -rn "SELECT \*" src/ --include="*.java" --include="*.sql"

# Formatting (Gradle only)
