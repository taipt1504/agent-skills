...
{
  "_comment": "devco-agent-skills — auto-generated by /dc-setup. Hooks are registered via plugin system (hooks/hooks.json).",
...
echo "    .claude/CLAUDE.md           — project conventions (~1,000 tokens)"
echo "    .claude/rules/              — 10 coding rules (flat)"
